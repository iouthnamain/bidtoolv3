      ...
      <div className="space-y-6 p-2">
        ...
        >
          <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-slate-800">
            <Plus className="h-4 w-4 text-blue-700" aria-hidden />
            Thêm tổ chức
          </div>
        ...
        <div className="overflow-hidden rounded border border-slate-400">
          <div className="flex items-center justify-between border-b border-slate-400 bg-slate-50 px-4 py-2.5">
            <span className="flex items-center gap-2 text-sm font-semibold text-slate-700">
              <Building2 className="h-4 w-4 text-slate-700" aria-hidden />
              Danh sách tổ chức
            </span>
            <Button
              variant="ghost"
                    ...
                    {editing ? (
                      <div className="flex flex-1 flex-wrap items-center gap-2">
                        <input
                          ...
                          disabled={busy}
                          className="h-9 flex-1 rounded border border-slate-500 bg-white shadow-[var(--shadow-flat)] px-2 text-sm text-slate-900 focus-visible:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-100 focus-visible:outline-none"
                          autoFocus
                        />
                        <Button
                          size="sm"
