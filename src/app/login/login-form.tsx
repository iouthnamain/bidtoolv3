          ...
          <form className="space-y-4 px-6 py-2" onSubmit={handleSubmit} noValidate>
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="h-11 w-full rounded border border-slate-500 bg-white shadow-[var(--shadow-flat)] px-3 text-sm text-slate-900 transition-colors duration-0 focus-visible:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-100 focus-visible:outline-none disabled:cursor-not-allowed disabled:bg-slate-100"
              />
            </div>
